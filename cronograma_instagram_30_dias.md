...
```mermaid
graph TD
    A["Semana 1: Atração & Comparativo de Preço"] --> B["Semana 2: Desejo & Variedade de Conteúdo"]
    B --> C["Semana 3: Quebra de Objeções & Facilidade Técnica"]
    C --> D["Semana 4: Escassez, Combos & Fechamento de Vendas"]
```
