...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dr0vVt5K.mjs");
...
const manifest = {
  "9ec040322c5ff67b5dc2607a0798a7718f8a7ebb61c8310e1db74d3f7f70b425": {
    functionName: "createShopOrderFn_createServerFn_handler",
    importer: () => import("./shop-checkout.functions-D9GsRrq2.mjs")
  },
  "08b47ac5e7a118ac08719ef9884c78c84f086938b790ed104561971dccace4fa": {
    functionName: "getShopOrderStatusFn_createServerFn_handler",
    importer: () => import("./shop-checkout.functions-D9GsRrq2.mjs")
  },
  "75b142e5c9770a891e2d5c29406f36a4ad9d1ca46a65138def4dd6794805fb82": {
    functionName: "createNitroPix_createServerFn_handler",
    importer: () => import("./nitro.functions-x2WFgBAS.mjs")
  },
  "857122ff8a242f3c735b6bef8370745444908d765d5d1ca993aae1430dfeb3c9": {
    functionName: "createNitroCard_createServerFn_handler",
    importer: () => import("./nitro.functions-x2WFgBAS.mjs")
  },
  "8f81452859eb2a6341d8982a5376e5a50cd04b5d15cf38adeb25617f3dee9709": {
    functionName: "checkNitroPixStatus_createServerFn_handler",
    importer: () => import("./nitro.functions-x2WFgBAS.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DUs2VTm4.mjs").then((n) => n.r),
