...
export function NavbarGlassFixa() {
  ...
  return (
    <nav
      className={
        "fixed left-1/2 top-9 sm:top-8 md:top-5 z-50 flex w-[calc(100%-24px)] sm:w-[calc(100%-48px)] max-w-3xl -translate-x-1/2 flex-col rounded-2xl border border-white/10 py-2.5 px-3.5 sm:px-4 md:py-3 md:pl-5 md:pr-3.5 backdrop-blur-xl transition-all duration-300 " +
        (scrolled
    ...
    >
      <div className="flex items-center justify-between w-full">
        {/* Logo */}
        <a href="#" className="flex items-center gap-2 text-sm sm:text-base font-bold tracking-tighter uppercase text-white font-heading shrink-0">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          <a
            href="#planos"
            className="rounded-[8px] sm:rounded-[10px] bg-[#970202] hover:bg-[#b80303] px-3 py-1.5 sm:px-4.5 sm:py-2 text-[11px] sm:text-[13.5px] font-bold text-white shadow-[0_4px_16px_rgba(151,2,2,0.6)] transition-all font-heading tracking-wide uppercase shrink-0"
          >
            Cadastrar
          </a>
