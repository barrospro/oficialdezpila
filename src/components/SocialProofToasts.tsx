...
const names = [
  "Ricardo", "Mariana", "Lucas", "Fernanda", "Rafael", "Amanda",
  "Thiago", "Juliana", "Pedro", "Carolina", "Bruno", "Gabriela",
  "Felipe", "Larissa", "Diego", "Camila", "Gustavo", "Patrícia",
  "Rodrigo", "Beatriz", "André", "Letícia", "Marcelo", "Vanessa",
];

const cities = [
  "São Paulo, SP", "Rio de Janeiro, RJ", "Belo Horizonte, MG",
  "Curitiba, PR", "Porto Alegre, RS", "Salvador, BA", "Recife, PE",
  "Fortaleza, CE", "Brasília, DF", "Manaus, AM", "Goiânia, GO",
